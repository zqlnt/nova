...
export const seedUserAccounts: UserAccount[] = [
  { id: 'ua_org_1', email: 'zain@ttutors.co.uk', role: 'org', orgId: ORG_ID, active: true, createdAt: '2026-03-01T10:00:00Z', updatedAt: '2026-03-01T10:00:00Z' },
  ...
  { id: 'ua_teacher_1', email: 'zain@ttutors.co.uk', role: 'teacher', orgId: ORG_ID, teacherId: 'teacher_zain', active: true, createdAt: '2026-03-01T10:00:00Z', updatedAt: '2026-03-01T10:00:00Z' },
