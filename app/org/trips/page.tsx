      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <Link href="/org/calendar">
              <Card hover className="p-5 cursor-pointer border border-white/45 hover:border-indigo-300 group">
            ...
            <Link href="/org/calendar">
              <Card hover className="p-5 cursor-pointer border border-white/45 hover:border-pink-300 group">
